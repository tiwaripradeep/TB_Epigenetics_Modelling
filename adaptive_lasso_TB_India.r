...
#######################################################
dat_cv<-readRDS("/projects/sunlab/Students_Work/Pradeep_work/TB_modelling/India/data_TB_India_methylation.RDS")
...
foldid<-readRDS("/projects/sunlab/Students_Work/Pradeep_work/TB_modelling/India/LASSO/foldid.RDS")
